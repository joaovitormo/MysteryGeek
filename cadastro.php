...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link rel="icon" href="img/icon.png" />
		...
		<title>Cadastro - Mystery Geek</title>
</head>
...
<div class="barra_pesquisa">
	...
	<div class="contents">
			...
			<form action="valida_cadastro.php" class="cadastro-form" method="post">
          <font class="Titulo">Cadastro</font><br><br>
				<h2>Dados Pessoais</h2><br>
          <b style="color: #DC0505">Campos marcados com * são de preenchimento obrigatório.</b>
        <div class="txtb">
		...
		<div class="txtb">
			<input type="text" required name="data" maxlength="10" OnKeyPress="formatar('##/##/####', this)" >
			<span data-placeholder="Data de nascimento*"></span>
		</div> 
				
		<div class="txtb">
          <input type="text" required name="cpf" maxlength="14" OnKeyPress="formatar('###.###.###-##', this)">
          <span data-placeholder="CPF/CNPJ*"></span>
        </div>
		
		<div class="txtb">
          <input type="text" name="tel" maxlength="12" OnKeyPress="formatar('##-####-####', this)" >
          <span data-placeholder="Telefone residencial"></span>
        </div>
		
		<div class="txtb">
          <input type="text" required name="cel" maxlength="13" OnKeyPress="formatar('##-#####-####', this)" >
        ...
        <div class="txtb">
          ...
          <span data-placeholder="Senha*"></span>
			...
			<input type="checkbox"> <b>Desejo receber promoções em meu email.</b><br><br>
    		<input type="submit" class="cadbtn" value="enviar">
