...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="BOTTON GAMER COGUMELO VERDE 1UP">BOTTON GAMER COGUMELO VERDE 1UP<br />
                    <img src="img/botton-3.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="3,98">R$ 3,99</td>
