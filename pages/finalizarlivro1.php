...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Box Harry Potter - Série Completa">Box Harry Potter - Série Completa<br />
                    <img src="img/livro 1.png" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="200,00">R$ 199,99</td>
