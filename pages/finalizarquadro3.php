...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Quadro decorativo Incrível Hulk">Quadro decorativo Incrível Hulk<br />
                    <img src="img/quadro-3.png" width="200px"; height="200px"
                    </td>
