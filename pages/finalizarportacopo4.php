...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA COPOS COGUMELOS E BLOCOS">PORTA COPOS COGUMELOS E BLOCOS<br />
                    <img src="img/portacopo-4.jpg" width="200px"; height="200px"
                    </td>
