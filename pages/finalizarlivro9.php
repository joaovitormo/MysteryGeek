...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Livro O Livro Da Mitologia – Edição Especial">Livro O Livro Da Mitologia – Edição Especial<br />
                    <img src="img/livro-9.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="62,98">R$ 62,99</td>
