...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA TRECO CAVEIRA MEXICANA">PORTA TRECO CAVEIRA MEXICANA<br />
                    <img src="img/portatreco-5.jpg" width="200px"; height="200px"
                    </td>
