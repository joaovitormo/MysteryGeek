...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca de Chopp Game of Thrones I Drink I Know Things">Caneca de Chopp Game of Thrones I Drink I Know Things<br />
                    <img src="img/caneca-3.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="39,98">R$ 39,99</td>
