...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca de Chopp Ponei Saltitante">Caneca de Chopp Ponei Saltitante<br />
                    <img src="img/caneca-1.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="29,98">R$ 29,99</td>
