...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caderno Univ 12x1 240f Homem de Ferro">Caderno Univ 12x1 240f Homem de Ferro<br />
                    <img src="img/caderno-2.jpg" width="200px"; height="200px"
                    </td>
