...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA TRECO CABEÇA DE MONSTRO">PORTA TRECO CABEÇA DE MONSTRO<br />
                    <img src="img/portatreco-4.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="64,98">R$ 64,99</td>
