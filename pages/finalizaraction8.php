...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Action Figure Orochimaru Dxtra - Xtra Figures">Action Figure Orochimaru Dxtra - Xtra Figures<br />
                    <img src="img/actionfigures-8.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="589,98">R$ 589,99</td>
