...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Harry Potter: Hogwarts - Salão Principal">Harry Potter: Hogwarts - Salão Principal<br />
                    <img src="img/tabuleiro-7.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="300,00">R$ 299,99</td>
