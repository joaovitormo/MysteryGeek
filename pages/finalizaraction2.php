...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Boneco Mohawk: Gremlins 2: A Nova Geração">Boneco Mohawk: Gremlins 2: A Nova Geração<br />
                    <img src="img/actionfigures-2.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="69,98">R$ 69,99</td>
