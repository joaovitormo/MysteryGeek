...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Livro The Walking Dead – A Ascensão do Governador">Livro The Walking Dead – A Ascensão do Governador<br />
                    <img src="img/livro-8.jpg" width="200px"; height="200px"
                    </td>
