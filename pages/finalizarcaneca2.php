...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca Game of Thrones Escudo Targaryen 3D">Caneca Game of Thrones Escudo Targaryen 3D<br />
                    <img src="img/caneca-2.jpg" width="200px"; height="200px"
                    </td>
