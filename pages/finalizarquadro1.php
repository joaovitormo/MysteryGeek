...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Quadro decorativo Homem de Ferro">Quadro decorativo Homem de Ferro<br />
                    <img src="img/quadro-1.png" width="200px"; height="200px"
                    </td>
