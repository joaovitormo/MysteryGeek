...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="CAPTAIN AMERICA - CAPITÃO AMÉRICA - AVENGERS: INFINITY WAR">CAPTAIN AMERICA - CAPITÃO AMÉRICA - AVENGERS: INFINITY WAR<br />
                    <img src="img/actionfigures-5.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="359,98">R$ 359,99</td>
