...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Funko Pop Avengers - Thanos">Funko Pop Avengers - Thanos<br />
                    <img src="img/funko-3.png" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="110,98">R$ 110,99</td>
