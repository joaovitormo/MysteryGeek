...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA COPOS GAMER BOY COFFEE YES">PORTA COPOS GAMER BOY COFFEE YES<br />
                    <img src="img/portacopo-3.jpg" width="200px"; height="200px"
                    </td>
