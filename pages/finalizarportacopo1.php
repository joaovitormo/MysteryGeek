...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA COPOS DISQUETE - FLOPPY DISK">PORTA COPOS DISQUETE - FLOPPY DISK<br />
                    <img src="img/portacopo-1.jpg" width="200px"; height="200px"
                    </td>
          ...
          <span data-placeholder="Cidade*"></span>
			...
			<b>Forma de pagamento</b>
				...
				<tr>
					...
					<td>Total: R$<input name="total" type="number" "resultado2" readonly id="resultado2" min="1" max="4" ></td>
