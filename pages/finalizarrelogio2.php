...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Relógio Despertador DC Batman Logo">Relógio Despertador DC Batman Logo<br />
                    <img src="img/relogio-2.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="100,00">R$ 99,99</td>
