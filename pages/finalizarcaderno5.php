...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caderno Capa Dura Mulher Maravilha 96 Folhas Jandaia">Caderno Capa Dura Mulher Maravilha 96 Folhas Jandaia<br />
                    <img src="img/caderno-5.jpg" width="200px"; height="200px"
                    </td>
